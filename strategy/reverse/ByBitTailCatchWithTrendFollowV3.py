...
class ByBitTailCatchWithTrendFollowV3(bt.Strategy):
    params=dict(
        log=True,
        risks={
            ...
            'SHIB1000USDT': [Decimal('2'), Decimal('4'), Decimal('4'), Decimal('4'), Decimal('8')],
        ...
        atr_constant={
            ...
            'SHIB1000USDT': [Decimal('1.0'), Decimal('1.0')],
        ...
        percent={
            ...
            'SHIB1000USDT': {
                'bull': [Decimal('3.0'), Decimal('6.0'), Decimal('10.0'), Decimal('12.0'), Decimal('15.0')],
                'def': [Decimal('3.0'), Decimal('6.0'), Decimal('10.0'), Decimal('12.0'), Decimal('15.0')],
                'bear':[Decimal('3.0'), Decimal('6.0'), Decimal('10.0'), Decimal('12.0'), Decimal('15.0')],
            },
            'ONDOUSDT': {
                'bull': [Decimal('3.0'), Decimal('6.0'), Decimal('10.0'), Decimal('12.0'), Decimal('15.0')],
                'def': [Decimal('3.0'), Decimal('6.0'), Decimal('10.0'), Decimal('12.0'), Decimal('15.0')],
            ...
            'TAOUSDT': {
                'bull': [Decimal('4.0'), Decimal('6.0'), Decimal('10.0'), Decimal('12.0'), Decimal('15.0')],
                'def': [Decimal('4.0'), Decimal('6.0'), Decimal('10.0'), Decimal('12.0'), Decimal('15.0')],
...
if __name__ == '__main__':
    ...
    cerebro = bt.Cerebro()
    cerebro.addstrategy(ByBitTailCatchWithTrendFollowV3)
