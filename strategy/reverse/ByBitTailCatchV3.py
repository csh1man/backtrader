...
class ByBitTailCatchV3(bt.Strategy):
    params=dict(
        ...
        risk={
            ...
            'SHIB1000USDT': [Decimal('2.0'), Decimal('2.0'), Decimal('4.0'), Decimal('4.0'), Decimal('8.0')],
...
if __name__ == '__main__':
    ...
    cerebro = bt.Cerebro()
    cerebro.addstrategy(ByBitTailCatchV3)
