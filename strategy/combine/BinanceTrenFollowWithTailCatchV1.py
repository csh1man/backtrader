...
pairs = {
    ...
    'XRPUSDT': DataUtils.CANDLE_TICK_4HOUR,
    # '1000SHIBUSDT': DataUtil.CANDLE_TICK_4HOUR,
}

leverage=5

class BinanceTrendFollowWithTailCatchV1(bt.Strategy):
    params=dict(
        log=True,
        risks={
            ...
            'XRPUSDT': [Decimal('2.0'), Decimal('2.0'), Decimal('4.0'), Decimal('4.0'), Decimal('8.0')],
            'DOGEUSDT': [Decimal('2.0'), Decimal('2.0'), Decimal('4.0'), Decimal('4.0'), Decimal('8.0')],
        ...
        atr_constant={
            'BTCUSDT': [Decimal('1.0'), Decimal('2.0')],
            'ETHUSDT': [Decimal('1.0'), Decimal('2.0')],
            'SOLUSDT': [Decimal('1.0'), Decimal('2.0')],
            'BCHUSDT': [Decimal('2.0'), Decimal('1.0')],
            'XRPUSDT': [Decimal('2.0'), Decimal('1.0')],
            'DOGEUSDT': [Decimal('2.0'), Decimal('1.0')],
            '1000SHIBUSDT': [Decimal('2.0'), Decimal('1.0')],
        },
        high_band_length={
            'BTCUSDT': [40, 5],
            'ETHUSDT': [40, 5],
        ...
        percent={
          'XRPUSDT': {
              'bull': [Decimal('4.0'), Decimal('5.0'), Decimal('10.0'), Decimal('20.0'), Decimal('25.0')],
              'def': [Decimal('4.0'), Decimal('5.0'), Decimal('10.0'), Decimal('20.0'), Decimal('25.0')],
              'bear': [Decimal('5.0'), Decimal('10.0'), Decimal('15.0'), Decimal('20.0'), Decimal('25.0')],
          },
          '1000SHIBUSDT': {
                'bull': [Decimal('4.0'), Decimal('5.0'), Decimal('10.0'), Decimal('20.0'), Decimal('25.0')],
                'def': [Decimal('8.0'), Decimal('10.0'), Decimal('15.0'), Decimal('20.0'), Decimal('25.0')],
                'bear': [Decimal('5.0'), Decimal('10.0'), Decimal('15.0'), Decimal('20.0'), Decimal('25.0')],
          }
        },
        rsi_length={
...
if __name__ == '__main__':
    ...
    cerebro = bt.Cerebro()
    cerebro.addstrategy(BinanceTrendFollowWithTailCatchV1)
    ...
    for pair, tick_kind in pairs.items():
        file_name += pair + "-"
    file_name += "BinanceTrendFollowWithTailCatchV1"
