    ...
    def next(self):
        ...
        for i in range(0, len(self.pairs)):
            ...
            if current_position_size == 0:
                if name in ['BTCUSDT', 'ETHUSDT', 'BCHUSDT', 'SOLUSDT', 'EOSUSDT']:
