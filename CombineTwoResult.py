...
if __name__ == '__main__':
    ...
    # df2 = pd.read_csv('C:/Users\KOSCOM\Desktop\각종자료\개인자료\krInvestment\백테스팅데이터\결과/1000PEPEUSDT-SUIUSDT-1000BONKUSDT-XRPUSDT-DOGEUSDT-TailCatchWithBBAltCoinV1.csv', parse_dates=['date'])
